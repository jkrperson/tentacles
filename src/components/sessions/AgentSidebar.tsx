...
export function AgentSidebar() {
  ...
  return (
    <div className="flex flex-col h-full bg-[var(--t-bg-surface)]">
        ...
        <div className="relative" ref={dropdownRef}>
          <div className="flex items-center gap-0.5">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 text-[12px] font-medium text-zinc-300 hover:text-zinc-100 bg-[var(--t-bg-elevated)] hover:bg-[var(--t-bg-hover)] border border-[var(--t-border)] rounded-md px-3 py-1.5 transition-colors"
            >
            ...
            <button
              ...
              className="text-zinc-500 hover:text-zinc-200 bg-[var(--t-bg-elevated)] hover:bg-[var(--t-bg-hover)] border border-[var(--t-border)] rounded-md p-1.5 transition-colors"
            >
      ...
      {/* Bottom */}
      <div className="flex-shrink-0 border-t border-[var(--t-border)] px-2 py-2 flex items-center justify-between">
        <button
          onClick={handleAddProject}
          className="flex items-center gap-2 text-[11px] font-medium text-zinc-400 hover:text-zinc-200 hover:bg-[var(--t-bg-hover)] rounded-md px-2 py-1.5 transition-colors"
        >
          <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
        ...
        <button
          ...
          className="text-zinc-500 hover:text-zinc-200 hover:bg-[var(--t-bg-hover)] p-1.5 rounded-md transition-colors"
          title="Settings"
        >
